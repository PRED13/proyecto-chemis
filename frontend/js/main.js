...
function aumentarCantidad() {
    ...
    const input =
        document.getElementById('modal-cantidad-input');
...
function confirmarCantidad() {
    ...
    const index =
        carrito.findIndex(
            item => item.id === productoEnModal.id
        );
    ...
    if (typeof toastr !== 'undefined') {
        toastr.success(
            `✓ ${productoEnModal.nombre} añadido al carrito`
        );
    }
}
